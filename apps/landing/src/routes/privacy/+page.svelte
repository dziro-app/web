<div class="wrapper">
  ...
  <p>
    El presente Política de Privacidad establece los términos en que DZIRO usa y
  ...
  <p>
    ...
    Nombre e información de contacto como su dirección de correo
    electrónica. Así mismo cuando sea necesario podrá
  ...
  <p>
    DZIRO está altamente comprometido para cumplir con el compromiso de mantener
  ...
  <p>
    ...
    somos responsables de los términos o privacidad ni de la protección de sus datos en esos otros sitios terceros. Dichos sitios
  ...
  <p>
    DZIRO Se reserva el derecho de cambiar los términos de la presente Política de
...
<style lang="scss" >
  ...
  .wrapper {
    padding: sizing.sizing(2) sizing.sizing(4);
  }
