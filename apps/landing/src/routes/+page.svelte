<script lang='ts' >
  ...
  import CollectionButton from "ui/lib/CollectionButton.svelte"
  import CollectionItem from "ui/lib/CollectionItem.svelte"
...
<div class="Landing">
  ...
  <div class="logo">
    <a class="link" href="https://free.dziro.app" rel="noreferrer" >
      Usa la versión abierta, 100% gratuita, por siempre y para siempre.
    </a>
    <a href="https://pro.dziro.app" rel="noreferrer">
      <Logo color="black" />
    </a>
  </div>
  ...
  <div id="video">
    ...
    <div>
      <a href="https://pro.dziro.app" rel="noreferrer">
        <Button> <div class="emoji" > 👉 </div> IR A LA APP</Button>
      </a>  
    </div>
  </div>
    ...
    <div class="feature" id="lists" >
      ...
      <div class="show">
        <div class="full" style={`transform: rotateZ(${randomNumber(-20, 0)}deg)`} >
          <CollectionButton name="Libros"  color="#1C84FF" emoji="📚"/>
        </div>
        <div style={`transform: rotateZ(${randomNumber(0, 20)}deg)`}>
          <CollectionButton name="Ropa"  color="#EDE63E" emoji="👕"/>
        </div>
        <div style={`transform: rotateZ(${randomNumber(-20, 0)}deg)`}>
          <CollectionButton name="Hogar"  color="#52E469" emoji="🏠"/>
        </div>
        <div class="full" style={`transform: rotateZ(${randomNumber(-15, 15)}deg)`}>
          <CollectionButton name="Navidad"  color="#E45264" emoji="🎄"/>
        </div>
      </div>
  ...
  <footer>
    <div class="author">
      Hecho con  💜 por <a href="https://www.linkedin.com/in/everitosan/" rel="noreferrer" target="_blank" > evesan </a>
    </div>
    <div class="donations">
      <div>Donaciones</div>
      <a href="https://www.patreon.com/everitosan" target="_blank" rel="noreferrer">
...
<style lang='scss' >
  ...
  .Hero {
    ...
    grid-column-gap: sizing.sizing(4);
    justify-content: center;
    margin: 0 auto;
    max-width: 1060px;
    padding-top: sizing.sizing(8);
  ...
  #video {
    ...
    grid-gap: sizing.sizing(4);
    margin: sizing.sizing(15) 0;
